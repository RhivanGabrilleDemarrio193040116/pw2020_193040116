    ...
    <table border="1px" cellspacing="0" cellpadding="10">
      ...
      <?php foreach ($electronik as $electro) : ?>
        ...
        <tr>
          ...
          <td><?= $i ?></td>
          <td>
           <a href="ubah.php?id=<?= $electro['id']; ?>"><button class="ubah">Ubah</button></a>
            <a href="hapus.php?id=<?= $electro['id'] ?>" onclick="return confirm('Hapus Data?')"><button class="hapus">Hapus</button></a>
          </td>
